...
Output: grpo_unlearning_sft_grpo/checkpoint-{100,200,300}
...
Eval after this completes:
  python3 src/eval_multilevel.py \\
      --checkpoint grpo_unlearning_sft_grpo/checkpoint-300 \\
      --base_model grpo_unlearning_sft/merged \\
